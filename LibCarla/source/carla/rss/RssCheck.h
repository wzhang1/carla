...
namespace rss {
  ...
  private:
    ...
    std::shared_ptr<::ad_rss::world::RssDynamics> mEgoVehicleDynamics;
    std::shared_ptr<::ad_rss::world::RssDynamics> mOtherVehicleDynamics;
    ...
    void calculateLatLonVelocities(const carla::geom::Transform &laneLocation,
